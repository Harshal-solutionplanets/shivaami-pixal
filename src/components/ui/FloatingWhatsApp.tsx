...
export default function FloatingWhatsApp() {
  return (
    <a
      href="https://wa.me/919022223600?text=Hi%20TaxPrint%20%26%20TaxPrint & TaxPrint & TaxPrint & TaxPrint & Shivaami%2C%20I%27m%20interested%20in%20Google%20Pixel%20for%20Business"
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-2xl hover:bg-[#20ba5a] hover:scale-110 active:scale-95 transition-all duration-200 group"
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 scale-0 transition-all rounded bg-gray-900 px-3 py-1.5 text-xs text-white group-hover:scale-100 whitespace-nowrap shadow-lg pointer-events-none">
